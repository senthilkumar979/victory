...
export const javascriptRoadmap: RoadmapData = {
  ...
  nodes: [
    ...
    },
    {
      ...
      description: "Arrow Function is a new way of creating functions with the '=>' operator with a shorter syntax. ## Example ```js const sayHello = () => { console.log(`Hello from Arrow Function !`); } ```",
      resources: [
        {
    ...
    },
    {
      ...
      description: "Conditional operator also known as Ternary operator is the only JS operator that takes three operands. The operator can have one of two values based on a condition. Syntax: `condition ? val_for_true : val_for_false`",
      resources: [
        {
          title: "JavaScript MDN Docs",
    ...
    },
    {
      ...
      title: "Frontend",
      description: "Learn more about Frontend in the JavaScript ecosystem.",
      resources: [
        {
    ...
    },
    {
      ...
      title: "Global Scope",
      description: "Variables declared Globally (outside any function) have Global Scope. Global variables can be accessed from anywhere in a JavaScript program. Variables declared with `var`, `let` and `const` are quite similar when declared outside a block. ## Note If you assign a value to a variable  that has not been declared i.e `potato = true` it will automatically become a _GLOBAL_ variable.",
      resources: [
        {
          title: "MDN \u2014 JavaScript Guide",
          url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide",
    ...
    },
    {
      ...
      title: "IIFE",
      description: "Immediately-Invoked Function Expression is a function that is executed immediately after it is created. ## Example ```js // An Async IIFE ( async() => { const x = 1; const y = 9; console.log(`Hello, The Answer is ${x+y}`); })(); ```",
      resources: [
        {
          title: "IIFE \u2014 MDN Docs",
    ...
    },
    {
      ...
      title: "JavaScript",
      description: "JavaScript is the programming language of the web. It runs in browsers and on servers (Node.js), and powers interactive sites, apps, and APIs.",
      resources: [
        {
    ...
    },
    {
      ...
      description: "Loops offer a quick and easy way to do something repeatedly. You can think of a loop as a computerized version of the game where you tell someone to take X steps in one direction, then Y steps in another. For example, the idea \"Go five steps to the east\" could be expressed this way as a loop: ```js for (let step = 0; step < 5; step++) { // Runs 5 times, with values of step 0 through 4. console.log('Walking east one step'); } ```",
      resources: [
        {
    ...
    },
    {
      ...
      title: "Node.js",
      description: "Learn more about Node.js in the JavaScript ecosystem.",
      resources: [
        {
          title: "MDN \u2014 JavaScript Guide",
          url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide",
    ...
    },
    {
      ...
      title: "Object.is",
      description: "The Object.is() static method determines whether two values are the same value. ```js console.log(Object.is('1', 1)); // Expected output: false console.log(Object.is(NaN, NaN)); // Expected output: true console.log(Object.is(-0, 0)); // Expected output: false const obj = {}; console.log(Object.is(obj, {})); // Expected output: false ```",
      resources: [
        {
          title: "Object.is() - MDN",
    ...
    },
    {
      ...
      title: "React",
      description: "Learn more about React in the JavaScript ecosystem.",
      resources: [
        {
          title: "MDN \u2014 JavaScript Guide",
          url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide",
    ...
    },
    {
      ...
      description: "In addition to the comparison operators, which can be used on string values, the concatenation operator (`+`) concatenates two string values together, returning another string that is the union of the two operand strings. The shorthand assignment operator `+=` can also be used to concatenate strings.",
      resources: [
        {
    ...
    },
    {
      ...
      title: "TypeScript",
      description: "Learn more about TypeScript in the JavaScript ecosystem.",
      resources: [
        {
          title: "MDN \u2014 JavaScript Guide",
          url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide",
    ...
    },
    {
      ...
      title: "JavaScript Chrome Dev Tools",
    ...
    },
    {
      ...
      description: "`break` statement, without a label reference, can only be used to jump out of a loop or a switch block. `continue` statement, with or without a label reference, can only be used to skip one loop iteration.",
      resources: [
        {
    ...
    },
    {
      ...
      title: "If else",
      description: "The `if` statement executes a statement if a specified condition is `truthy`. If the condition is `falsy`, another statement in the optional `else` clause will be executed. ## Example ```js if (condition) { statement1; } else { statement2; } ```",
      resources: [
        {
    ...
    },
    {
      ...
      description: "The keyword `this` when used in a function refers to the global object. _Note: in a browser window the global object is the `window` object._",
      resources: [
        {
          title: "MDN \u2014 JavaScript Guide",
          url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide",
    ...
    },
    {
      ...
      title: "roadmap.sh",
      description: "Learn more about roadmap.sh in the JavaScript ecosystem.",
      resources: [
        {
          title: "MDN \u2014 JavaScript Guide",
          url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide",
    ...
    },
    {
      ...
      title: "undefined",
      description: "undefined is a Primitive data type in Javascript. Whenever a variable is declared but not initialized or assigned a value, then it is stored as undefined. A function returns undefined if a value was not returned. A method or statement also returns undefined if the variable that is being evaluated does not have an assigned value.",
      resources: [
        {
    ...
    },
    {
      ...
      description: "The keyword `this` when used alone refers to the global object. _Note: in a browser window the global object is the `window` object._",
      resources: [
        {
          title: "MDN \u2014 JavaScript Guide",
          url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide",
