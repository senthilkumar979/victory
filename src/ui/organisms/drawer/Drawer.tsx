...
const DrawerTitle = ({ children, description }: DrawerTitleProps) => (
  <header className="relative flex flex-col gap-1.5 pr-8">
    <h2 className="text-sm font-semibold tracking-tight sm:text-base font-['Urbanist',system-ui,sans-serif] tracking-wide border-l-2 border-primary pl-2 text-primary">
      {children}
    </h2>
    {description ? (
