...
export const PageMain = ({ children }: { children: React.ReactNode }) => {
  return (
    ...
    >
      {/* Ambient background - pointer-events-none so they don't block clicks */}
      ...
      <div className="pointer-events-none absolute -right-1/4 bottom-1/4 h-96 w-96 rounded-full bg-info/10 blur-[120px]" />
      {children}
    </motion.main>
  )
}
