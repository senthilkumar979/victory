...
interface RadialOrbitalTimelineProps {
  ...
  /** When true, uses a bounded height suitable for embedding in a page section. */
  embedded?: boolean;
  className?: string;
}
...
export function RadialOrbitalTimeline({
  ...
  return (
    <div
      className={cn(
        "w-full flex flex-col items-center justify-center bg-black overflow-hidden",
        embedded
          ? "min-h-[min(72vh,720px)] h-[min(72vh,720px)] max-h-[720px]"
          : "h-screen",
        className
      )}
      ref={containerRef}
